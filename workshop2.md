...
- [https://github.com/scie1006-workshop/2026/blob/main/workshop2.md](https://github.com/scie1006-workshop/2026/blob/main/workshop2.md)
...
## Part 4: Sign up for a MongoDB Atlas account
   ...
   1. Click on "Database & Network Access" in the SECURITY section of the left panel.

      ![](images/network-access0.png)
      
   1. Click on "IP Access List" in the NETWORK ACCESS section of the left panel. In the window on the right, change the IP address by clicking "EDIT" after that.
...
## Part 6: Visualizing sensor data with MongoDB
   ...
   1. Under the "Project Overvew", click the "Visualization" in the SERVICES section.

      ![](images/mongodb-charts0.png)
